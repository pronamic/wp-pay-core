...
class PaymentTest extends TestCase {
	 ...
	 */
	public function test_construct_initializes_refunded_amount_currency_from_total_amount() {
	 ...
	 */
	public function test_from_json_preserves_currency_in_refunded_amount() {
		$json_data = (object) [
			'total_amount' => (object) [
				'value'    => '25',
				'currency' => 'USD',
